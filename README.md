...
and using this understanding to develop models.
...
### Market Context
- Alberta's wholesale electricity market runs on a merit order structure where generator bids are sorted
...
An anomaly is then defined as a departure from what is normal for that hour, regardless of the overall price level.
